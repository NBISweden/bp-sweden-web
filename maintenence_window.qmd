...
The visas have to be part of the access token.

### SDA CLI

It is now possible to provide the the authentication token in the environment instead of having it in the configuration file.
