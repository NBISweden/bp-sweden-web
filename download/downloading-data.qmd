...
Upon publicizing encrypted data in a public folder in the S3 outbox bucket, admins will send an email to the requester. This email will contain a URL that leads to a text file named `urls_list.txt`, which includes URLs of all requested datasets.
