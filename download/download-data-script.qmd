---
title: Script for downloading data
---

The following script can be used to download the encrypted files listed in a
text file. It allows you to maintain the structure of the dataset.

<a href="/download_data.sh" download="download_data.sh"><button>Download</button></a>
