...
We are currently piloting submissions to the archive. Express your
interest in submitting data to us by entering your information below.

To get an overview of the process, see our [submission quick
guide](submission-quick-guide.qmd)
...
<div>
  <input type="checkbox" id="controlledAccess" name="controlledAccess" value="controlledAccess" class="form-check-input" autocomplete="off" required/>
  ...
  <fieldset>
    ...
    <fieldset class="form-group">
      <p class="form-label">Type of submission: *</p>
      <div>
...
<script>
  const ProjectId = "sensitive-data-archive";
  const TrackerId = 10; // Data Submission Request tracker
  const SKULD = "{{< env SKULD >}}";
  ...
  async function onSubmit(token) {
    ...
    if (!token) {
      console.log("captcha error, no token.");
      showUserMessage('There was a problem processing your data. Please try again.');
      return
    }
