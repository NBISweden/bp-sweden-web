...
The user needs to wait for approval from the data access committee (DAC) and since it is approved the user can download the datasets.
...
This can be done by foolowing the instructions in the sda-cli documentation in the `List datasets and their files` section [here](https://github.com/NBISweden/sda-cli#list-datasets-and-their-files).
