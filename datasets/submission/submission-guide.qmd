...
We recommend that you upload two images and generate metadata for them according to the preparation guide, please include all XML files don't forget the `PRIVATE` folder or the `LANDING_PAGE` (in case you want one of those).
